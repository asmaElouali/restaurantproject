...
const PaymentMethode: React.FC<PaymentMethodProps> = ({
    paymentMode,
    name,
    icon,
    isIcon,
    ...
    return (
        <View style={[styles.PaymentCardContainer, { borderColor: paymentMode == name ? COLORS.primaryOrangeHex : COLORS.primaryGreyHex, },]}>
            {isIcon ? (
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} colors={[COLORS.primaryBlackHex, COLORS.primaryBlackHex]} style={styles.LinearGradientRegular}>
